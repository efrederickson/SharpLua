    ...
    public partial class Lua
    {
        ...
        private static BinOpr getbinopr(int op)
        {
            switch (op)
            {
                ...
                case (int)RESERVED.TK_RSHIFT: return BinOpr.OPR_RSHIFT;
                case (int)RESERVED.TK_LSHIFT: return BinOpr.OPR_LSHIFT;
                case (int)RESERVED.TK_BITAND: return BinOpr.OPR_BITAND;
                case (int)RESERVED.TK_BITOR: return BinOpr.OPR_BITOR;

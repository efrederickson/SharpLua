...
namespace SharpLua
{
    ...
    public partial class Lua
    {
        ...
        */
        ...
        public static lua_Hook lua_gethook(LuaState L)
        {
            return L.hook;
        }


        public static int lua_gethookmask(LuaState L)
        {
            return L.hookmask;
        }


        public static int lua_gethookcount(LuaState L)
        {
            return L.basehookcount;
        }


        public static int lua_getstack(LuaState L, int level, lua_Debug ar)
        {
            int status;
            CallInfo ci;
            lua_lock(L);
        ...
        public static CharPtr lua_getlocal(LuaState L, lua_Debug ar, int n)
        {
        ...
        public static CharPtr lua_setlocal(LuaState L, lua_Debug ar, int n)
        {
            CallInfo ci = L.base_ci[ar.i_ci];
            CharPtr name = findlocal(L, ci, n);
            lua_lock(L);
        ...
        */
                    ...
                    case OpCode.OP_GETUPVAL:
                        {
                            ...
                            name = (p.upvalues != null) ? getstr(p.upvalues[u]).ToString() : "?";
                            return "upvalue";
                        }
                    case OpCode.OP_SELF:
                        {
        ...
        public static void luaG_errormsg(LuaState L)
        {
            if (L.errfunc != 0)
        ...
        public static void luaG_runerror(LuaState L, CharPtr fmt, params object[] argp)
        {

...
namespace SharpLua
{
	...
	public partial class Lua
	{
		...
		public static Closure luaF_newCclosure (LuaState L, int nelems, Table e) {
		...
		public static Closure luaF_newLclosure (LuaState L, int nelems, Table e) {
		...
		public static Proto luaF_newproto (LuaState L) {
		...
		public static void luaF_freeproto (LuaState L, Proto f) {
		...
		public static void luaF_freeclosure (LuaState L, Closure c) {
